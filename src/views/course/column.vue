<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" icon="el-icon-edit" @click="addColumn">
        新增专栏
      </el-button>
      <el-button
        class="filter-item"
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="300">
        <template slot-scope="{ row, $index }">
          <el-button type="warning" size="mini" @click="handleMemu(row,$index)">
            目录
          </el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="更新状态" prop="updatestatus">
          <el-radio v-model="temp.updatestatus" label="1">连载中</el-radio>
          <el-radio v-model="temp.updatestatus" label="0">已完结</el-radio>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible = false">取消</el-button>
        <el-button type="primary" @click="dialogStatus === 'create' ? handleAdd() : updateColumn1()"> {{ dialogStatus === "create" ? "完成添加" : "修改提交" }}</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async handleAdd() {
      ...
      console.log(data);
      let res = await createColumn(data);
      console.log(res);
      if (res.code === 20000) {
    ...
    async updateColumn1(){
        ...
        console.log(this.temp);
        let res = await updateColumn(this.temp)
        console.log(res);
        if(res.code === 20000){
